...
urlpatterns = [
    ...
    path('settings/ddns/register/', views_settings.settings_ddns_register, name='settings_ddns_register'),
    path('settings/ddns/check-domain/', views_settings.settings_ddns_check_domain, name='settings_ddns_check_domain'),
    path('settings/ddns/finalize/', views_settings.settings_ddns_finalize, name='settings_ddns_finalize'),
    path('settings/ddns/captcha/', views_settings.settings_ddns_captcha, name='settings_ddns_captcha'),
