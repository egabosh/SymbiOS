...
urlpatterns = [
    ...
    path('services/<str:service_name>/', views_services.services_detail, name='services_detail'),
    path('services/<str:service_name>/action/', views_services.services_action, name='services_action'),
    path('services/<str:service_name>/status/', views_services.services_status, name='services_status'),
